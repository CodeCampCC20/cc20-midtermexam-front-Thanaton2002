...
function LoginPage() {
  ...
  const setUser = useAuthStore(state => state.getUserId) 
  ...
  <div className="w-[100vw] h-[100vh] flex justify-center items-center bg-[#121826]">
    <div className="card bg-[#212936] w-96 shadow-sm">
      <form className="card-body p-10" onSubmit={handleSubmit}>
        <h1 className="text-3xl font-bold text-base-100 mb-2">Login</h1>
        <InputForm
          id="username"
        ...
        <a className="text-base-100 text-xs font-bold cursor-pointer hover:text-base-100/50" onClick={()=> navi('/register')}>REGISTER HERE</a>
      </form>
    </div>
  </div>
)
